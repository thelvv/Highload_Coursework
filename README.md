...
## 7. Список серверов
### NGINX
NGINX без требования мощного железа обеспечит обработку суммарных ~4000 RPS. Для отказоустойчивости и надежности используется два сервера
...
Для отказоустойчивости и надежности серверы имеют характеристики с запасом, а также дубируются  
