...
Для хранения __информации просмотрах__ выбрана NoSQL СУБД __Clickhouse__ c дополнительным контуром в виде кэша для обеспечения высокого RPS, так как она аналогично является распространенным решением для данной задачи  
...
## 6. Схема проекта
![Схема проекта](https://github.com/thelvv/Highload_Coursework/assets/59176894/bb1b3d3a-51cc-43cd-a743-3112ae7290e1)
