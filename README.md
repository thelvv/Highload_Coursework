...
## 6. Схема проекта
![Схема проекта](https://github.com/thelvv/Highload_Coursework/assets/59176894/0ae08fe5-f76c-4337-a097-379b8575348d)
...
Для хранения и получения данных об объявлениях выбраны промышленные серверные конфигурации c увеличенным объемом постоянной и оперативной памяти  
Аналогично сервера продублированы для повышения отказоустойчивости
| Характеристика         | Значение  |
|------------------------|:---------:|
| CPU                    | 128 ядер  |
